...
# Category → Unsplash photo ID (permanent, free)
CATEGORY_PHOTOS = {
...
Include variety: festivals, markets, concerts, outdoor activities, food events.
Return ONLY a JSON array, no other text:
[{{"name":"Event","date":"Sat Mar 22","time":"10am-4pm","location":"Venue","description":"One engaging sentence about why visitors would love this.","url":"https://example.com"}}]"""
    ...
    for i, loc in enumerate(LOCATIONS):
        ...
        if not events:
            ...
            for e in events:
                ...
                link_open  = f'<a href="{e["url"]}" target="_blank" rel="noopener" class="card-link">' if e.get("url") else '<div class="card-link">'
                link_close = "</a>" if e.get("url") else "</div>"
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                {"<span class='cta'>Learn More →</span>" if e.get("url") else ""}
              </div>
            </div>
            {link_close}"""
